...
const PrivacyPolicy = () => {
  return (
    <section className={`py-20 md:py-28 ${montserrat.className}`}>
      <div className="container max-w-4xl mx-auto px-4">
        <div className="prose prose-invert max-w-none">
          <h1 className="text-4xl md:text-5xl font-bold text-[#B62706] mb-6">
            Privacy Policy
          </h1>
          <p className="text-white/80 mb-4">Last updated: July 17, 2025</p>
          ...
          <ul className="text-white/80 space-y-4 mb-8 list-disc pl-6">
            <li>
              <p>
            ...
            <li>
              <p>
                ...
                188TCHAT, the software program provided by the Company.
              </p>
            </li>
            <li>
              <p>
                ...
                or &quot;Our&quot; in this Agreement) refers to 188TCHAT.
              </p>
            </li>
            <li>
              <p>
          ...
          <ul className="text-white/80 space-y-2 mb-6 list-disc pl-6">
            <li>
              <p>Email address</p>
            </li>
            <li>
          ...
          <ul className="text-white/80 space-y-4 mb-6 list-disc pl-6">
            <li>
              <p>
          ...
          <ul className="text-white/80 list-disc pl-6">
            <li>
              By email:{" "}
              <a
                href="mailto:contact@188tchat.com"
                className="text-[#B62706] hover:underline"
              >
                contact@188tchat.com
              </a>
            </li>
          </ul>
        </div>
